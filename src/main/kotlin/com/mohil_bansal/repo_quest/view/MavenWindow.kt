...
class MavenWindow(private val project: Project) {
    ...
    private var repositoryTab: JTabbedPane
    ...
    init {
        ...
        artifactTableModel = ArtifactTableModel(JBTable())
        ...
        mavenPanel.add(repositoryTab, BorderLayout.SOUTH)
        repositoryTab.isVisible = true // Make sure it is visible
