...
class PackageTableModel(private val table: JBTable) : DefaultTableModel() {
    private val columnNames = arrayOf("Index", "Package Name", "Author", "Last Version", "Description")

    private var data: List<PackageItem>? = null
    ...
    private fun convertData(packageItem: PackageItem): Vector<Any> {
    ...
    fun setupTable(list: List<PackageItem>) {
        this.data = list
    ...
    private fun updateData(packageItem: PackageItem, index: Int) {
